...
/**
 * DeliveryAddressSearch represents the model behind the search form of `app\modules\admin\models\DeliveryAddress`.
 */
class DeliveryAddressSearch extends DeliveryAddress
{
    ...
    {
        return [
            [['id', 'id_gorod', 'id_user'], 'integer'],
            [['name', 'street', 'home', 'flat', 'comment'], 'safe'],
        ];
    }
